...
namespace franka_pole
{
    ...
    private:
        ...
        //Control
        Eigen::Matrix<double, 3, 1> _input_acceleration;            ///< Acceleration from higher level controllers
        Eigen::Matrix<double, 6, 1> _acceleration_target;           ///< Target cartesian acceleration, sum of input acceleration and cartesian control in pure dynamics mode
        ...
        Eigen::Matrix<double, 7, 1> _joint_accelerations_target;    ///< Target joint accelerations, computed from _acceleration_target
        ...
        void _inverse_dynamics_control();                                                   ///< Applies inverse dynamics controller, also adds gravity and Coriolis terms. Affects _torque
